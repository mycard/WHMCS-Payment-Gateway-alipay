...
class alipayfull_link {
    ...
    public function normal_f2fpay($params){
        ...
        $qrPayRequestBuilder->setSubject("服务器订单 [# ".$params['invoiceid']." ]");
    ...
    public function mapi_get_basicconfig($params){
        ...
        "transport" => "https",
        "payment_type" => 1,
        "return_url" =>  "https://pay.blockfightroushan.com/modules/gateways/callback/alipay_full/return.php",
        "notify_url" => "https://pay.blockfightroushan.com/modules/gateways/callback/alipay_full/notify.php",
    ...
    public function f2fpay_get_basicconfig($params){
        return [
            ...
            'notify_url' => "https://pay.blockfightroushan.com/modules/gateways/callback/alipay_full/f2fpay_notify.php",
            'MaxQueryRetry' => "10",
            'QueryDuration' => "3"
        ];
    }
